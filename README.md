...
4. **[Computation & Speed Comparison](model_architectures/03_Computation_and_Speed_Comparison.md)**: A guide explaining the hardware cost and inference time of each model family.
